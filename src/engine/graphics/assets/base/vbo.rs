...
pub struct VBO {
    ...
    texture_id: Option<GLuint>,     // Optional texture ID associated with the VBO
}
...
impl VBO {
    ...
    pub fn new(data: &[f32]) -> Self {
        ...
        Self {
            ...
            texture_id: None, // Initialize without a texture
        }
    }

    // Set a texture ID for this VBO
    pub fn set_texture(&mut self, texture_id: GLuint) {
        self.texture_id = Some(texture_id);
    }

    // Get the texture ID if it exists
    pub fn get_texture(&self) -> Option<GLuint> {
        self.texture_id
    }
